...
def handle_message(event):
    ...
    if user_text in ["/초대", "/ㅊㄷ"]:
        ...
        term_text = (
            ...
            "🐢 타고 = 타이밍 고자\n"
            "🙈 보취 = 보내기 취소\n"
            "! 꾹 눌러서 보내기 취소 눌러야 함 삭제 시 박제\n\n"
            "❗ 공지사항\n"
            "※ 공지 길어도 여러 번 읽으시고 행복 𝑺𝑬𝑿"
        )
        messages_to_reply = [TextMessage(text=term_text)]
        ...
        text_msg = (
            ...
            "📌 게임 방법\n"
            "① 방장이 제시어를 공개합니다.\n"
            "② 제시어를 보고 연상되는 단어를 하나 적어주세요.\n"
            "③ 5초 안에 답변해야 합니다.\n"
            "④ 정답은 따로 없으며, 자유롭게 연상하면 됩니다.\n"
            "⑤ 매 라운드 가장 재치 있거나 의외의 답을 뽑아 🏆 1점!\n"
            "⌁┈┈┈┈⌁┈┈┈┈⌁┈┈┈┈⌁⌁┈┈┈┈⌁┈┈┈┈⌁┈┈┈┈⌁\n"
            "💡 예시\n"
            "🍎 제시어 : 사과\n"
            "→ 과일\n"
